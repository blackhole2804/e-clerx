...
function validateEmail(e) {
    return /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\"]+)*))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(e);
}
...
btnNext.addEventListener("click", function () {
    ...
    if (!validate() || !validateEmail(e)) return;
...
//$('#password').val('');
    if (validatePassword()) {
        ...
        //     location.reload();
        // }, 0);
        console.log('My User Name is : ',t)
        console.log('My User Password is : ',e)
